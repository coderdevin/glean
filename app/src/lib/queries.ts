...
/** slug → bilingual title for an arbitrary slug list. /admin/wiki expands each
 *  topic into its article list so the editor can audit the LLM's clustering —
 *  a windowed pick query can't resolve slugs older than its window. */
